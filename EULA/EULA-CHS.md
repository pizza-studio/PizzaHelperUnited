...
本合约为您（以下简称「用户」）与本团队（以下简称「开发者」）就用户使用敝应用程序服务所订立之协议。合约说明用户与开发者间有关敝应用程序服务之权利义务。「用户」系指下载、使用或浏览本服务之个人或机构。
...
5. 用户不得利用应用程序传送下列内容：
   - 违反中华人民共和国宪法基本原则或危害国家安全之内容；
   - 损害国家荣誉、利益，或煽动民族歧视、破坏民族团结之内容；
   - 传播不实之资讯、淫秽、暴力、恐怖等法律禁止之内容；
   - 其他在地法律及行政规范所禁止之内容。
...
敝应用程序不会传送用户资料至开发者服务器。用户所有个人资料仅用于与相关服务的互动及个人化功能，开发者不搜集用户隐私资讯。
