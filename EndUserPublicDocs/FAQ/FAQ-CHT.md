...
1. HoYoLAB 或米遊社：實時便箋、個人戰報、帳簿、遊戲統計、抽卡記錄獲取、角色庫存清單、遊戲活動。
...
- 星穹鐵道的武器在 20 & 30 & 40 & 50 & 60 & 70 級時沒有任何辦法判斷是否有經過等級突破，只能以「尚未完成等級突破」為前提來推斷此時的武器面板數據。
