...
1. HoYoLAB と米游社：リアルタイム便箋、個人作戦報告、元帳、統計簿、ガチャ記録の受け取り、「持っているキャラの一覧」、ゲームイベント。
...
> このセクションでは、ピザ助手（無印）バージョン5.0.5以降の問題について説明します。
...
3. ローカルプロファイルをアプリに再インポートしてください。このオプションは、ステップ 1 で述べた同じメニューにあります。
