...
ピザヘルパーの「通常アイテム命中率信憑度」機能は、ガチャゲームにおける通常アイテム命中率計算の信頼性指標を提供します。この機能は、利用可能なデータ量に基づいて、ガチャ統計の信頼度をユーザーが理解するのに役立ちます。
...
ガチャ統計セクションで信憑度指標を見る際、それをタップして詳細な説明を表示できます。これは i18n キー `gachaKit.stats.confidence.alert.message` を使用したローカライズされたアラートをトリガーし、お好みの言語で信憑度指標に関する包括的な情報を提供します。
