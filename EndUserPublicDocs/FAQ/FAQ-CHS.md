...
1. HoYoLAB 或米游社：实时便笺、个人战报、账簿、游戏统计、抽卡记录获取、角色库存清单、游戏活动。
...
1. 前往「本地账号管理器 -> 菜单（位于界面右上角）」并使用相关菜单选项将所有本地账号导出为备份文件。在完成步骤 2 后，您需要使用此备份文件将本地账号重新导入到披萨小助手内。
2. 在相同的菜单中，进入「进阶选项」并将「本地账号存储位置」切换为「应用程序容器」。切换此选项后，披萨小助手会自动退出。
3. 将本地账号导入到披萨小助手内。此选项位于步骤 1 所述的菜单中。
