// 《拿铁小助手》v5.8.3 的更新内容简述：

- 新增对《星穹铁道》v4.3 的新角色（应星•千冶）与新武器、新圣遗物的支持。
- （米游社账号 QRCode 登入的故障已在 v5.8.2 中解决。）
...
// 《拿鐵小助手》v5.8.3 的更新內容簡述：

- 新增對《星穹鐵道》v4.3 的新角色（應星•千冶）與新武器、新聖遺物的支援。
- （米遊社帳號 QRCode 登入的故障已在 v5.8.2 中解決。）
...
// Major changes introduced in The Latte Helper v5.8.3:

- Added support for new characters (Yingxing • Mortenax) and new weapons & new artifacts introduced in Star Rail v4.3.
- (The Miyoushe QR Code login issue was resolved in v5.8.2.)
...
- このアップデートにて、当アプリは『スターレイル』v4.3 の新キャラクター（応星・千冶）と新しい武器＆聖遺物に対応しました。
- （米遊社アカウントのQRコードログインの問題は v5.8.2 にて解決済みです。）
...
// Основные изменения в «Латте помощник» v5.8.3:

- Добавлена поддержка новых персонажей (Инсин: Мортенакс), а также нового оружия и артефактов, представленных в Star Rail v4.3.
- (Проблема со входом через QR-код в Miyoushe была решена в v5.8.2.)
