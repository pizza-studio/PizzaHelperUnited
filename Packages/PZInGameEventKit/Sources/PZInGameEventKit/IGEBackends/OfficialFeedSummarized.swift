...
extension OfficialFeed {
    ...
    public static func summarize(
        ...
        let contentList = package.content.list
        contentList.forEach { rawContent in
        ...
        metaStack.forEach { rawMeta in
            ...
            guard let contentDescription = contentObj.content else { return }
            guard let bannerImageLink = contentObj.banner else { return }
