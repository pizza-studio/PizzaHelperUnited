...
extension UIGFv4 {
    public struct ProfileZZZ: Codable, Hashable, Sendable {
        ...
        public init(lang: GachaLanguage, list: [GachaItemZZZ], timezone: Int?, uid: String) {
            self.lang = lang
            self.list = list
            self.timezone = timezone ?? GachaKit.getServerTimeZoneDelta(uid: uid, game: .zenlessZone)
            self.uid = uid
        }
