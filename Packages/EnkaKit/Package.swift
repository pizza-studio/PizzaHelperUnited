...
let package = Package(
    ...
    dependencies: [
        ...
        .package(
            url: "https://github.com/pizza-studio/EnkaDBGenerator", .upToNextMajor(from: "1.5.0")
        ),
        .package(
            url: "https://github.com/pizza-studio/ArtifactRatingDB.git", .upToNextMajor(from: "1.0.6")
        ),
    ],
    targets: [
