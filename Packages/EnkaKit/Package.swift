...
let package = Package(
    ...
    dependencies: [
        ...
        .package(
            url: "https://github.com/pizza-studio/EnkaDBGenerator", .upToNextMajor(from: "1.5.4")
        ),
        .package(
            url: "https://github.com/pizza-studio/ArtifactRatingDB.git", .upToNextMajor(from: "1.0.8")
        ),
    ],
    targets: [
