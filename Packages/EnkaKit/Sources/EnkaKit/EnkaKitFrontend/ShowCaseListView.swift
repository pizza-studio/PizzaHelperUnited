...
@available(iOS 17.0, *)
@available(macCatalyst 17.0, *)
@available(macOS 14.0, *) private let enkaDatabaseHSR = try! Enka.EnkaDB4HSR(locTag: "zh-tw")
@available(iOS 17.0, *)
@available(macCatalyst 17.0, *)
@available(macOS 14.0, *) private let enkaDatabaseGI = try! Enka.EnkaDB4GI(locTag: "zh-tw")
// swiftlint:enable force_try
// swiftlint:enable force_unwrapping

@available(iOS 17.0, *)
@available(macCatalyst 17.0, *)
@available(macOS 14.0, *) private let summaryHSR: Enka.QueriedProfileHSR = {
    // swiftlint:disable force_try
    // swiftlint:disable force_unwrapping
...
@available(iOS 17.0, *)
@available(macCatalyst 17.0, *)
@available(macOS 14.0, *) private let summaryGI: Enka.QueriedProfileGI = {
    // swiftlint:disable force_try
    // swiftlint:disable force_unwrapping
    // Note: Do not use #Preview macro. Otherwise, the preview won't be able to access the assets.
    let packageRootPath = URL(fileURLWithPath: #file).pathComponents.prefix(while: { $0 != "Sources" }).joined(
